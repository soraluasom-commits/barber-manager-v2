const CACHE='barber-manager-auth-1';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./staff-days-off.js','./firebase-config.js','./cloud-merge.js','./cloud-sync.js','./theme-fix.css','./auth-gate.css'];
