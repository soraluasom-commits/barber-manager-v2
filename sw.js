const CACHE='barber-manager-theme-2';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icon.svg','./staff-days-off.js','./firebase-config.js','./cloud-merge.js','./cloud-sync.js','./theme-fix.css'];
